...
def test_compress_finding_strips_only_pipeline_metadata() -> None:
    finding = {
        ...
        "rule": {"id": "sql-injection-rule", "reference_id": None, "name": None, "native_severity": "CRITICAL", "native_confidence": "MEDIUM"},
        ...
        "wasc_ids": [],
        "location": {"kind": "code", "path": "routes/login.ts", "start_line": 34, "start_column": 5, "end_line": 34, "end_column": 40},
        "evidence": {
            "kind": "code",
            "code_evidence": {
                "code_snippet": {"content": "SELECT * FROM Users WHERE email = " + "'" + "req.body.email" + "'", "context_before": [], "context_after": []},
                "matched_contents": [],
                "related_context": [],
                "redacted": False,
                "truncated": False,
        ...
        "data_flow": [{"kind": "taint", "engine": "semgrep", "source": {"step_index": 0, "path": "routes/login.ts", "line": 34, "column": 5, "content": "req.body.email", "message": None}, "steps": [], "sink": {"step_index": 1, "path": "routes/login.ts", "line": 34, "column": 30, "content": "SELECT", "message": None}}],
        "solution": None,
        "references": ["https://owasp.org"],
        "raw_sources": [{"format": "semgrep-json", "report_path": "reports/raw/semgrep.json", "json_pointer": "/results/0"}],
    }
...
def test_build_user_prompt_redacts_sensitive_info() -> None:
        ...
        findings=[
            {
                ...
                "evidence": {
                    "http_evidence": {"request_excerpt": "POST /login email=test@secret.com&pass=123"}
                },
            }
        ],
    ...
    kb_snippets = [
        {"doc_id": "cwe_89", "title": "CWE-89: SQL Injection", "summary": "SQL Injection summary"}
    ]
