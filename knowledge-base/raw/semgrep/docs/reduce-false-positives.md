...
<Steps>
  ...
  <Step>
    ...
    <pre>semgrep scan --config='<span class="placeholder">SEMGREP\_RULES\_FOLDER/'</span></pre>
  </Step>
</Steps>
...
<pre>semgrep scan --config='<span class="placeholder">SEMGREP\_RULES\_FOLDER</span>/<span class="placeholder">NAME\_OF\_IMPROVED\_RULE</span>.yaml'</pre>
